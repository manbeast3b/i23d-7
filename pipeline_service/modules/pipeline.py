...
class GenerationPipeline:
    ...
    async def generate_gs(self, request: GenerateRequest) -> GenerateResponse:
        ...
        image_edited = self.qwen_edit.edit_image(
            prompt_image=image,
            seed=request.seed,
            prompt="Show this exact same object from an isometric three-quarter view from the opposite view, 45-degree angle perspective. Keep the exact same object type, design, materials, colors, and style from the input image. The object should be centered and fully visible against a clean white background. Maintain all original details, textures, and proportions. Three-quarter angle perspective, clear and sharp details.",
        )
